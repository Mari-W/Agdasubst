...
constructor corresponds to a typing rule in System~F.

TODO: expression renamings and substitution

TODO: progress

TODO: expression substitution laws (monad laws for substitutions)

\subsection{Examples}
\label{sec:examples-1}

TODO: Church numerale
...
corresponding equality proof puts some load on the type checker and
...
This function is a glorified identity function. It abstracts over a
binary type constructor $\kappa$, two types $\beta$ and $\alpha$, then
it takes an application function and applies it to suitable arguments.
\FOPrelude
