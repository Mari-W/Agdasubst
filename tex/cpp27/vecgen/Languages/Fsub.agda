...
-- 64 rules -- 33 signature-independent, 15 for the
-- iterated (variable-arity) lifting, 16 traversal rules (one instᴿ-*
-- and one inst-* per constructor, plus the variable case).

{-# REWRITE
  def-wkᴿ def-∙ᴿ-zero def-∙ᴿ-suc def-↑ᴿ-zero def-↑ᴿ-suc
  instᴿ-var instᴿ-Top instᴿ-_⇒_ instᴿ-∀[<:_]_ instᴿ-λx[_]_ instᴿ-Λα[<:_]_
  instᴿ-_·_ instᴿ-_•_
  ...
  inst-var inst-Top inst-_⇒_ inst-∀[<:_]_ inst-λx[_]_ inst-Λα[<:_]_ inst-_·_
  inst-_•_
