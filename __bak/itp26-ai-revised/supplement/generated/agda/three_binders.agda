...
opaque
  ...
  instᴿ-vt   = refl
  instᴿ-lam  : (lam ty0 tm0) ⋯ᴿ ρ  ≡ lam (ty0 ⋯ᴿ ρ) (tm0 ⋯ᴿ (ρ ↑ᴿ* (tm ∷ vl ∷ [])))
  instᴿ-lam  = refl
  ...
  inst-vt   = refl
  inst-lam  : (lam ty0 tm0) ⋯ˢ σ  ≡ lam (ty0 ⋯ˢ σ) (tm0 ⋯ˢ (σ ↑ˢ* (tm ∷ vl ∷ [])))
  inst-lam  = refl
  ...
  compositionalityᴿˢ {σ₂ = σ₂} (lam ty0 tm0)  = cong2 lam (compositionalityᴿˢ ty0) (trans (compositionalityᴿˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-comp*ᴿˢ {σ₂ = σ₂} (tm ∷ vl ∷ []))))
  ...
  compositionalityˢᴿ {σ₁ = σ₁} (lam ty0 tm0)  = cong2 lam (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ {σ₁ = σ₁} (tm ∷ vl ∷ []))))
  ...
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (lam ty0 tm0)  = cong2 lam (compositionalityˢˢ ty0) (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ {σ₁ = σ₁} {σ₂ = σ₂} (tm ∷ vl ∷ []))))
