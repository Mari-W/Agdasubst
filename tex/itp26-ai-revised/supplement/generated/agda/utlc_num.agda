...
opaque
  ...
  instᴿ-lam   = refl
  instᴿ-const : (const nat0) ⋯ᴿ ρ   ≡ const (nat0 ⋯ᴿ ρ)
  instᴿ-const = refl
  instᴿ-Plus  : (Plus tm0 tm1) ⋯ᴿ ρ ≡ Plus (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
  instᴿ-Plus  = refl
  inst-app   : (app tm0 tm1) ⋯ˢ σ  ≡ app (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  inst-app   = refl
  inst-lam   : (lam tm0) ⋯ˢ σ      ≡ lam (tm0 ⋯ˢ (σ ↑ˢ* (tm ∷ [])))
  inst-lam   = refl
  inst-const : (const nat0) ⋯ˢ σ   ≡ const (nat0 ⋯ˢ σ)
  inst-const = refl
  inst-Plus  : (Plus tm0 tm1) ⋯ˢ σ ≡ Plus (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  inst-Plus  = refl
  ...
  compositionalityᴿˢ {σ₂ = σ₂} (const nat0)   = cong1 const (compositionalityᴿˢ nat0)
  compositionalityᴿˢ {σ₂ = σ₂} (Plus tm0 tm1) = cong2 Plus (compositionalityᴿˢ tm0) (compositionalityᴿˢ tm1)
  ...
  compositionalityˢᴿ {σ₁ = σ₁} (const nat0)   = cong1 const (compositionalityˢᴿ nat0)
  compositionalityˢᴿ {σ₁ = σ₁} (Plus tm0 tm1) = cong2 Plus (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  ...
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (const nat0)   = cong1 const (compositionalityˢˢ nat0)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (Plus tm0 tm1) = cong2 Plus (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
