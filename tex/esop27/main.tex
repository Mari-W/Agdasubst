...
\section{Comparison to Proof in Transfer Hell}
We compare this proof to the one without the additional 
definitional equalities for type substitutions, provided in the supplement 
for the aforementioned logical relation construction \cite{10.1145/3678000.3678201}. 
The authors use heterogeneous equality~\cite{} to proof the lemma, 
thereby already avoiding some of the troubles arising from transfer hell.
Without the use of heterogeneous equalities this proof gets even worse, and requires
multiple lemmas that shuffle the application of \AgdaFunction{subst} explicitly.
...
\begin{tabular}{|l|rr|rr|}
    ...
    \hline
    Type-check time (wall)                & \multicolumn{2}{c|}{4.49\,s}
...
\section{Proof for Compose Monad Law in Transfer Hell}\label{appendix:appendix-proof}

\AgdaNoSpaceAroundCode{}
\setlength{\mathindent}{0pt}
\footnotesize{}
% \EFExampleProofPrelude
% \ExampleProof
