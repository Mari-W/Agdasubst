...
opaque
  ...
  compositionalityˢᴿ (mu cmd0)         = cong1 mu (trans (compositionalityˢᴿ cmd0) (cong1 (cmd0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (stack ∷ []))))
  ...
  compositionalityˢˢ (mu cmd0)         = cong1 mu (trans (compositionalityˢˢ cmd0) (cong1 (cmd0 ⋯ˢ_) (lift-dist-compˢ*ˢ (stack ∷ []))))
