...
record Syntax : Set₁ where
  ...
  record Kit (_∋/⊢_ : List (Sort Var) → Sort Var → Set) : Set where
    ...
    opaque
      unfolding
        _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken
  ...
  record Traversal : Set₁ where
    ...
    opaque
      unfolding
        _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken id↑~id id↑*~id
    ...
    opaque
      unfolding
        _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken id↑~id id↑*~id Kᵣ Kₛ
    ...
    record ComposeKit  (K₁ : Kit _∋/⊢₁_) (K₂ : Kit _∋/⊢₂_)
      ...
      opaque
        unfolding
          _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken id↑~id id↑*~id Kᵣ Kₛ Wᵣ Wₛ
    ...
    record ComposeTraversal : Set₁ where
      ...
      opaque
        unfolding
          _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken id↑~id id↑*~id Kᵣ Kₛ Wᵣ Wₛ _·ₖ_ &/⋯-& dist-↑-· dist-↑*-·
      ...
      opaque
        unfolding
          _→ₖ_ _&_ wkm _∷ₖ_ _↑_ _↑*_ id ⦅_⦆ weaken id↑~id id↑*~id Kᵣ Kₛ Wᵣ Wₛ _·ₖ_ &/⋯-& dist-↑-· dist-↑*-· ↑-wk ⋯-↑-wk Cₛ Cₛ
      ...
      module Autosubst where
        opaque
          ...
          -- prevent empty opaque block warning
          _ : ℕ
          _ = 42
          
          postulate
            &-def₁             : (ρ : S₁ →ᵣ S₂) → zero & (x ∷ᵣ ρ) ≡ x
            &-def₂             : (ρ : S₁ →ᵣ S₂) → (suc x') & (x ∷ᵣ ρ) ≡ x' & ρ

            idᵣ-def            : (x : S ∋ s) → x & idᵣ ≡ x
