{-# OPTIONS --rewriting #-}  -- ★ confluence check OFF
-- ════════════════════════════════════════════════════════════════════════════
...
↾-⨾ (t ∙ σ) (os θ) (o' φ) = ↾-⨾ σ θ φ
↾-⨾ (t ∙ σ) (o' θ) φ      = ↾-⨾ σ θ φ
{-# REWRITE ↾-⨾ #-}   -- ★ associativity registered, ignoring the A-vs-B non-confluence
-- (was NOT registered before) — it clashes with the ↾-elimination clauses (the same
...
-- ════ does the distribution now fire DEFINITIONALLY (↾-⨾ registered)? ════
...
subTyTm (app f a) στ = app (subTyTm f στ) (subTyTm a στ)   -- ★ NO subst
subTyTm (lam b)   στ = lam (subTyTm b στ)                  -- ★ NO subst
