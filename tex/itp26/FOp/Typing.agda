...
-- context coherences (list-lifted pure FOp.Ty lemmas)
...
⊢-subTy {Γ = Γ} σ (⊢lam {A}{t}{B} d)  =
  subst (subCx Γ σ ⊢ lam (A ⟪ σ ⟫) (subTyTm t σ) ∶_) (sym (⟪⟫-⇒↑ A B σ)) (⊢lam (⊢-subTy σ d))
⊢-subTy {Γ = Γ} σ (⊢app {t}{u}{A}{B} df da) =
  ⊢app (subst (subCx Γ σ ⊢ subTyTm t σ ∶_) (⟪⟫-⇒↑ A B σ) (⊢-subTy σ df)) (⊢-subTy σ da)
