...
opaque
  ...
  traversal-tapp = refl
  traversal-vt   : (vt vl0) ⋯ˢ σ       ≡ vt (vl0 ⋯ˢ σ)
  traversal-vt   = refl
  traversal-lam  : (lam ty0 tm0) ⋯ˢ σ  ≡ lam (ty0 ⋯ˢ σ) (tm0 ⋯ˢ (σ ↑ˢ* (tm ∷ vl ∷ [])))
  traversal-lam  = refl
  ...
  right-idˢ (lam ty0 tm0)  = cong2 lam (right-idˢ ty0) (trans (cong1 (tm0 ⋯ˢ_) (lift-idˢ* (tm ∷ vl ∷ []))) (right-idˢ tm0))
  ...
  right-id (lam ty0 tm0)  = cong2 lam (right-id ty0) (trans (cong1 (tm0 ⋯ᴿ_) (lift-id* (tm ∷ vl ∷ []))) (right-id tm0))
  ...
  compositionalityᴿᴿ (lam ty0 tm0)  = cong2 lam (compositionalityᴿᴿ ty0) (trans (compositionalityᴿᴿ tm0) (cong1 (tm0 ⋯ᴿ_) (lift-dist-comp*ᴿᴿ (tm ∷ vl ∷ []))))
  ...
  compositionalityᴿˢ (vt vl0)       = cong1 vt (compositionalityᴿˢ vl0)
  compositionalityᴿˢ (lam ty0 tm0)  = cong2 lam (compositionalityᴿˢ ty0) (trans (compositionalityᴿˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-comp*ᴿˢ (tm ∷ vl ∷ []))))
  ...
  compositionalityˢᴿ (vt vl0)       = cong1 vt (compositionalityˢᴿ vl0)
  compositionalityˢᴿ (lam ty0 tm0)  = cong2 lam (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (tm ∷ vl ∷ []))))
  ...
  compositionalityˢˢ (vt vl0)       = cong1 vt (compositionalityˢˢ vl0)
  compositionalityˢˢ (lam ty0 tm0)  = cong2 lam (compositionalityˢˢ ty0) (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ (tm ∷ vl ∷ []))))
...
{-# REWRITE
  ...
  traversal-var traversal-arr traversal-all traversal-app traversal-tapp traversal-vt traversal-lam traversal-tlam
  right-id
