...
opaque
  ...
  traversal-tlam   = refl
  traversal-const  : (const string0) ⋯ˢ σ           ≡ const string0
  traversal-const  = refl
  traversal-tagged : (tagged string0 tm0) ⋯ˢ σ      ≡ tagged string0 (tm0 ⋯ˢ σ)
  traversal-tagged = refl
  traversal-pair   : (pair string0 ℕ0 tm0 tm1) ⋯ˢ σ ≡ pair string0 ℕ0 (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  traversal-pair   = refl
  ...
  compositionalityᴿˢ (const string0)           = cong1 const refl
  compositionalityᴿˢ (tagged string0 tm0)      = cong2 tagged refl (compositionalityᴿˢ tm0)
  compositionalityᴿˢ (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityᴿˢ tm0) (compositionalityᴿˢ tm1)
  ...
  compositionalityˢᴿ (all ty0)                 = cong1 all (trans (compositionalityˢᴿ ty0) (cong1 (ty0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (ty ∷ []))))
  compositionalityˢᴿ (app tm0 tm1)             = cong2 app (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  compositionalityˢᴿ (lam ty0 tm0)             = cong2 lam (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (tm ∷ []))))
  compositionalityˢᴿ (tapp tm0 ty0)            = cong2 tapp (compositionalityˢᴿ tm0) (compositionalityˢᴿ ty0)
  compositionalityˢᴿ (tlam tm0)                = cong1 tlam (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (ty ∷ []))))
  compositionalityˢᴿ (const string0)           = cong1 const refl
  compositionalityˢᴿ (tagged string0 tm0)      = cong2 tagged refl (compositionalityˢᴿ tm0)
  compositionalityˢᴿ (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  ...
  compositionalityˢˢ (all ty0)                 = cong1 all (trans (compositionalityˢˢ ty0) (cong1 (ty0 ⋯ˢ_) (lift-dist-compˢ*ˢ (ty ∷ []))))
  compositionalityˢˢ (app tm0 tm1)             = cong2 app (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
  compositionalityˢˢ (lam ty0 tm0)             = cong2 lam (compositionalityˢˢ ty0) (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ (tm ∷ []))))
  compositionalityˢˢ (tapp tm0 ty0)            = cong2 tapp (compositionalityˢˢ tm0) (compositionalityˢˢ ty0)
  compositionalityˢˢ (tlam tm0)                = cong1 tlam (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ (ty ∷ []))))
  compositionalityˢˢ (const string0)           = cong1 const refl
  compositionalityˢˢ (tagged string0 tm0)      = cong2 tagged refl (compositionalityˢˢ tm0)
  compositionalityˢˢ (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
...
{-# REWRITE
  ...
  traversal-var traversal-arr traversal-all traversal-app traversal-lam traversal-tapp traversal-tlam traversal-const traversal-tagged traversal-pair
  right-id
