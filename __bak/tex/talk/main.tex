...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Explicit syntactic symbols for variables, terms, and
          substitutions~\cite{10.1145/96709.96712}
  ...
  \begin{theorem}
    ...
    applying the reduction rules, are equal~\cite{10.1145/2676724.2693163}.
  \end{theorem}
...
\begin{frame}[fragile]
  ...
  New symbols for renamings demand additional laws~\cite{10.1145/3293880.3294101, Stark:2020:Mechanising})
  \EAssoc{}
...
\begin{frame}[fragile]
  ...
  \vspace{1em}
  \textbf{Idea.}
  Introduce new syntactic categories~\cite{ren-sub, saffrich:LIPIcs.ITP.2024.32} for
  \begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{The Sigma Calculus with Kits and Maps: Discussion}
  \begin{itemize}
