...
opaque
  ...
  compositionalityˢᴿ (ab ty0 exp0)            = cong2 ab (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ exp0) (cong1 (exp0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (exp ∷ []))))
  ...
  compositionalityˢᴿ (natCase exp0 exp1 exp2) = cong3 natCase (compositionalityˢᴿ exp0) (compositionalityˢᴿ exp1) (trans (compositionalityˢᴿ exp2) (cong1 (exp2 ⋯ˢ_) (lift-dist-compˢ*ᴿ (exp ∷ []))))
  compositionalityˢᴿ (sum ty0 ty1)            = cong2 sum (compositionalityˢᴿ ty0) (compositionalityˢᴿ ty1)
  compositionalityˢᴿ (sumCase exp0 exp1 exp2) = cong3 sumCase (compositionalityˢᴿ exp0) (trans (compositionalityˢᴿ exp1) (cong1 (exp1 ⋯ˢ_) (lift-dist-compˢ*ᴿ (exp ∷ [])))) (trans (compositionalityˢᴿ exp2) (cong1 (exp2 ⋯ˢ_) (lift-dist-compˢ*ᴿ (exp ∷ []))))
  ...
  compositionalityˢˢ (ab ty0 exp0)            = cong2 ab (compositionalityˢˢ ty0) (trans (compositionalityˢˢ exp0) (cong1 (exp0 ⋯ˢ_) (lift-dist-compˢ*ˢ (exp ∷ []))))
  ...
  compositionalityˢˢ (natCase exp0 exp1 exp2) = cong3 natCase (compositionalityˢˢ exp0) (compositionalityˢˢ exp1) (trans (compositionalityˢˢ exp2) (cong1 (exp2 ⋯ˢ_) (lift-dist-compˢ*ˢ (exp ∷ []))))
  compositionalityˢˢ (sum ty0 ty1)            = cong2 sum (compositionalityˢˢ ty0) (compositionalityˢˢ ty1)
  compositionalityˢˢ (sumCase exp0 exp1 exp2) = cong3 sumCase (compositionalityˢˢ exp0) (trans (compositionalityˢˢ exp1) (cong1 (exp1 ⋯ˢ_) (lift-dist-compˢ*ˢ (exp ∷ [])))) (trans (compositionalityˢˢ exp2) (cong1 (exp2 ⋯ˢ_) (lift-dist-compˢ*ˢ (exp ∷ []))))
