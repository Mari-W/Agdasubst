...
ap.add_argument("-x", "--hashname", metavar='PATH', default="",
                    help="Added to agda hashes json name")
...
if args.hashname:
    hashfile = f".agdatex-hashes-{str(args.hashname)}.json"
else:
    hashfile = ".agdatex-hashes.json"
...
try:
    with open(hashfile, "w") as digest:
