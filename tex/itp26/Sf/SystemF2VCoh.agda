...
-- ════════════════════════════════════════════════════════════════════════════
-- Sf.SystemF2VCoh — the TYPE-substitution coherence for the vector System F,
-- registered as rewrites (mirrors Sf.SystemFCoh).  selL-cop/selR-cop make the
-- TYPE substitution distribute over every type former DEFINITIONALLY, so the
-- type-distribution `(A⇒B)⟪στ⟫ ≡ A⟪στ⟫ ⇒ B⟪στ⟫` is refl.
-- ════════════════════════════════════════════════════════════════════════════
module Sf.SystemF2VCoh where
