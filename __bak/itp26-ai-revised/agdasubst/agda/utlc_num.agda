...
(const nat0)   ⋯ᴿ ρ = const (nat0 ⋯ᴿ ρ)
(Plus tm0 tm1) ⋯ᴿ ρ = Plus (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
...
opaque
  ...
  (const nat0)   ⋯ˢ σ = const (nat0 ⋯ˢ σ)
  (Plus tm0 tm1) ⋯ˢ σ = Plus (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  ...
  traversal-lam   = refl
  traversal-const : (const nat0) ⋯ˢ σ   ≡ const (nat0 ⋯ˢ σ)
  traversal-const = refl
  traversal-Plus  : (Plus tm0 tm1) ⋯ˢ σ ≡ Plus (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  traversal-Plus  = refl
  ...
  right-idˢ (const nat0)   = cong1 const (right-idˢ nat0)
  right-idˢ (Plus tm0 tm1) = cong2 Plus (right-idˢ tm0) (right-idˢ tm1)
  ...
  right-id (const nat0)   = cong1 const (right-id nat0)
  right-id (Plus tm0 tm1) = cong2 Plus (right-id tm0) (right-id tm1)
  ...
  compositionalityᴿᴿ (const nat0)   = cong1 const (compositionalityᴿᴿ nat0)
  compositionalityᴿᴿ (Plus tm0 tm1) = cong2 Plus (compositionalityᴿᴿ tm0) (compositionalityᴿᴿ tm1)
  ...
  compositionalityᴿˢ (const nat0)   = cong1 const (compositionalityᴿˢ nat0)
  compositionalityᴿˢ (Plus tm0 tm1) = cong2 Plus (compositionalityᴿˢ tm0) (compositionalityᴿˢ tm1)
  ...
  compositionalityˢᴿ (lam tm0)      = cong1 lam (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (tm ∷ []))))
  compositionalityˢᴿ (const nat0)   = cong1 const (compositionalityˢᴿ nat0)
  compositionalityˢᴿ (Plus tm0 tm1) = cong2 Plus (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  ...
  compositionalityˢˢ (lam tm0)      = cong1 lam (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ (tm ∷ []))))
  compositionalityˢˢ (const nat0)   = cong1 const (compositionalityˢˢ nat0)
  compositionalityˢˢ (Plus tm0 tm1) = cong2 Plus (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
...
{-# REWRITE
  ...
  traversal-var traversal-app traversal-lam traversal-const traversal-Plus
  right-id
