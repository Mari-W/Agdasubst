...
(lol ty0 ty1 ty2 ty3) ⋯ᴿ ρ = lol (ty0 ⋯ᴿ ρ) (ty1 ⋯ᴿ ρ) (ty2 ⋯ᴿ ρ) (ty3 ⋯ᴿ ρ)

variable
  tm0 tm1 : S ⊢ tm
  ty0 ty1 ty2 ty3 : S ⊢ ty
...
opaque
  ...
  (lol ty0 ty1 ty2 ty3) ⋯ˢ σ = lol (ty0 ⋯ˢ σ) (ty1 ⋯ˢ σ) (ty2 ⋯ˢ σ) (ty3 ⋯ˢ σ)
  ...
  traversal-lol : (lol ty0 ty1 ty2 ty3) ⋯ˢ σ ≡ lol (ty0 ⋯ˢ σ) (ty1 ⋯ˢ σ) (ty2 ⋯ˢ σ) (ty3 ⋯ˢ σ)
  ...
  right-idˢ (lol ty0 ty1 ty2 ty3) = cong4 lol (right-idˢ ty0) (right-idˢ ty1) (right-idˢ ty2) (right-idˢ ty3)
  ...
  right-id (lol ty0 ty1 ty2 ty3) = cong4 lol (right-id ty0) (right-id ty1) (right-id ty2) (right-id ty3)
...
traversal-var traversal-arr traversal-all 
-- AND SO ON
