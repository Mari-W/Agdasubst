...
$\delta$ (definition unfolding), and $\iota$ (pattern matching). The
additionally rewritten rules must agree with all of them to be confluent. 
...
% ===============================================
% TODO: cut renamings? this is analogous to subst
% ===============================================
...
\noindent The proof proceeds in six steps. Of these, steps~(2), (3), and~(5),
...
% \section{Practical Guidelines for Mechanizing Intrinsically Typed Syntax}
...
%alsoalso: we need to use --local-confluence-check instead of --confluence-check now, 
...
twice to zero. The proof that this term is equal to its normal form is
definitional.
\CNTwoProof
