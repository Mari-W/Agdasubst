...
opaque
  ...
  traversal-app : (app ne0 nf0) ⋯ˢ σ ≡ app (ne0 ⋯ˢ σ) (nf0 ⋯ˢ σ)
  traversal-app = refl
  traversal-val : (val ne0) ⋯ˢ σ     ≡ val (ne0 ⋯ˢ σ)
  traversal-val = refl
  ...
  compositionalityᴿˢ (lam nf0)     = cong1 lam (trans (compositionalityᴿˢ nf0) (cong1 (nf0 ⋯ˢ_) (lift-dist-comp*ᴿˢ (ne ∷ []))))
  ...
  compositionalityˢᴿ (lam nf0)     = cong1 lam (trans (compositionalityˢᴿ nf0) (cong1 (nf0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (ne ∷ []))))
  ...
  compositionalityˢˢ (lam nf0)     = cong1 lam (trans (compositionalityˢˢ nf0) (cong1 (nf0 ⋯ˢ_) (lift-dist-compˢ*ˢ (ne ∷ []))))
