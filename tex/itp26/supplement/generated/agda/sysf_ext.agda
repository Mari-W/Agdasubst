...
data _⊢[_]_ where 
  ...
  tlam   : (ty ∷ S) ⊢ tm → S ⊢ tm
  const  : String → S ⊢ tm
  tagged : String → S ⊢ tm → S ⊢ tm
  pair   : String → ℕ → S ⊢ tm → S ⊢ tm → S ⊢ tm
  α→β    : S ⊢ tm → S ⊢ tm → S ⊢ tm
  mkℕ′   : ℕ → S ⊢ tm
...
opaque
  ...
  (const string0)           ⋯ᴿ ρ = const string0
  (tagged string0 tm0)      ⋯ᴿ ρ = tagged string0 (tm0 ⋯ᴿ ρ)
  (pair string0 ℕ0 tm0 tm1) ⋯ᴿ ρ = pair string0 ℕ0 (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
  (α→β tm0 tm1)             ⋯ᴿ ρ = α→β (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
  (mkℕ′ ℕ0)                 ⋯ᴿ ρ = mkℕ′ ℕ0
...
opaque
  ...
  (const string0)           ⋯ˢ σ = const string0
  (tagged string0 tm0)      ⋯ˢ σ = tagged string0 (tm0 ⋯ˢ σ)
  (pair string0 ℕ0 tm0 tm1) ⋯ˢ σ = pair string0 ℕ0 (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  (α→β tm0 tm1)             ⋯ˢ σ = α→β (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  (mkℕ′ ℕ0)                 ⋯ˢ σ = mkℕ′ ℕ0
  ...
  instᴿ-app    = refl
  instᴿ-lam    : (lam ty0 tm0) ⋯ᴿ ρ             ≡ lam (ty0 ⋯ᴿ ρ) (tm0 ⋯ᴿ (ρ ↑ᴿ* (tm ∷ [])))
  instᴿ-lam    = refl
  instᴿ-tapp   : (tapp tm0 ty0) ⋯ᴿ ρ            ≡ tapp (tm0 ⋯ᴿ ρ) (ty0 ⋯ᴿ ρ)
  instᴿ-tapp   = refl
  instᴿ-tlam   : (tlam tm0) ⋯ᴿ ρ                ≡ tlam (tm0 ⋯ᴿ (ρ ↑ᴿ* (ty ∷ [])))
  instᴿ-tlam   = refl
  instᴿ-const  : (const string0) ⋯ᴿ ρ           ≡ const string0
  instᴿ-const  = refl
  instᴿ-tagged : (tagged string0 tm0) ⋯ᴿ ρ      ≡ tagged string0 (tm0 ⋯ᴿ ρ)
  instᴿ-tagged = refl
  instᴿ-pair   : (pair string0 ℕ0 tm0 tm1) ⋯ᴿ ρ ≡ pair string0 ℕ0 (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
  instᴿ-pair   = refl
  instᴿ-α→β    : (α→β tm0 tm1) ⋯ᴿ ρ             ≡ α→β (tm0 ⋯ᴿ ρ) (tm1 ⋯ᴿ ρ)
  instᴿ-α→β    = refl
  instᴿ-mkℕ′   : (mkℕ′ ℕ0) ⋯ᴿ ρ                 ≡ mkℕ′ ℕ0
  instᴿ-mkℕ′   = refl
  ...
  inst-app    = refl
  inst-lam    : (lam ty0 tm0) ⋯ˢ σ             ≡ lam (ty0 ⋯ˢ σ) (tm0 ⋯ˢ (σ ↑ˢ* (tm ∷ [])))
  inst-lam    = refl
  inst-tapp   : (tapp tm0 ty0) ⋯ˢ σ            ≡ tapp (tm0 ⋯ˢ σ) (ty0 ⋯ˢ σ)
  inst-tapp   = refl
  inst-tlam   : (tlam tm0) ⋯ˢ σ                ≡ tlam (tm0 ⋯ˢ (σ ↑ˢ* (ty ∷ [])))
  inst-tlam   = refl
  inst-const  : (const string0) ⋯ˢ σ           ≡ const string0
  inst-const  = refl
  inst-tagged : (tagged string0 tm0) ⋯ˢ σ      ≡ tagged string0 (tm0 ⋯ˢ σ)
  inst-tagged = refl
  inst-pair   : (pair string0 ℕ0 tm0 tm1) ⋯ˢ σ ≡ pair string0 ℕ0 (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  inst-pair   = refl
  inst-α→β    : (α→β tm0 tm1) ⋯ˢ σ             ≡ α→β (tm0 ⋯ˢ σ) (tm1 ⋯ˢ σ)
  inst-α→β    = refl
  inst-mkℕ′   : (mkℕ′ ℕ0) ⋯ˢ σ                 ≡ mkℕ′ ℕ0
  inst-mkℕ′   = refl
  ...
  right-idˢ (lam ty0 tm0)             = cong2 lam (right-idˢ ty0) (trans (cong1 (tm0 ⋯ˢ_) (lift-idˢ* (tm ∷ []))) (right-idˢ tm0))
  ...
  right-idˢ (const string0)           = cong1 const refl
  right-idˢ (tagged string0 tm0)      = cong2 tagged refl (right-idˢ tm0)
  right-idˢ (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (right-idˢ tm0) (right-idˢ tm1)
  right-idˢ (α→β tm0 tm1)             = cong2 α→β (right-idˢ tm0) (right-idˢ tm1)
  right-idˢ (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
  ...
  right-id (lam ty0 tm0)             = cong2 lam (right-id ty0) (trans (cong1 (tm0 ⋯ᴿ_) (lift-id* (tm ∷ []))) (right-id tm0))
  ...
  right-id (const string0)           = cong1 const refl
  right-id (tagged string0 tm0)      = cong2 tagged refl (right-id tm0)
  right-id (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (right-id tm0) (right-id tm1)
  right-id (α→β tm0 tm1)             = cong2 α→β (right-id tm0) (right-id tm1)
  right-id (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
  ...
  compositionalityᴿᴿ  (tagged string0 tm0)      = cong2 tagged refl (compositionalityᴿᴿ tm0)
  compositionalityᴿᴿ  (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityᴿᴿ tm0) (compositionalityᴿᴿ tm1)
  compositionalityᴿᴿ  (α→β tm0 tm1)             = cong2 α→β (compositionalityᴿᴿ tm0) (compositionalityᴿᴿ tm1)
  compositionalityᴿᴿ  (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
  ...
  compositionalityᴿˢ {σ₂ = σ₂} (lam ty0 tm0)             = cong2 lam (compositionalityᴿˢ ty0) (trans (compositionalityᴿˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-comp*ᴿˢ {σ₂ = σ₂} (tm ∷ []))))
  ...
  compositionalityᴿˢ {σ₂ = σ₂} (const string0)           = cong1 const refl
  compositionalityᴿˢ {σ₂ = σ₂} (tagged string0 tm0)      = cong2 tagged refl (compositionalityᴿˢ tm0)
  compositionalityᴿˢ {σ₂ = σ₂} (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityᴿˢ tm0) (compositionalityᴿˢ tm1)
  compositionalityᴿˢ {σ₂ = σ₂} (α→β tm0 tm1)             = cong2 α→β (compositionalityᴿˢ tm0) (compositionalityᴿˢ tm1)
  compositionalityᴿˢ {σ₂ = σ₂} (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
  ...
  compositionalityˢᴿ {σ₁ = σ₁} (all ty0)                 = cong1 all (trans (compositionalityˢᴿ ty0) (cong1 (ty0 ⋯ˢ_) (lift-dist-compˢ*ᴿ {σ₁ = σ₁} (ty ∷ []))))
  compositionalityˢᴿ {σ₁ = σ₁} (app tm0 tm1)             = cong2 app (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  compositionalityˢᴿ {σ₁ = σ₁} (lam ty0 tm0)             = cong2 lam (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ {σ₁ = σ₁} (tm ∷ []))))
  compositionalityˢᴿ {σ₁ = σ₁} (tapp tm0 ty0)            = cong2 tapp (compositionalityˢᴿ tm0) (compositionalityˢᴿ ty0)
  compositionalityˢᴿ {σ₁ = σ₁} (tlam tm0)                = cong1 tlam (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ {σ₁ = σ₁} (ty ∷ []))))
  compositionalityˢᴿ {σ₁ = σ₁} (const string0)           = cong1 const refl
  compositionalityˢᴿ {σ₁ = σ₁} (tagged string0 tm0)      = cong2 tagged refl (compositionalityˢᴿ tm0)
  compositionalityˢᴿ {σ₁ = σ₁} (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  compositionalityˢᴿ {σ₁ = σ₁} (α→β tm0 tm1)             = cong2 α→β (compositionalityˢᴿ tm0) (compositionalityˢᴿ tm1)
  compositionalityˢᴿ {σ₁ = σ₁} (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
  ...
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (all ty0)                 = cong1 all (trans (compositionalityˢˢ ty0) (cong1 (ty0 ⋯ˢ_) (lift-dist-compˢ*ˢ {σ₁ = σ₁} {σ₂ = σ₂} (ty ∷ []))))
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (app tm0 tm1)             = cong2 app (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (lam ty0 tm0)             = cong2 lam (compositionalityˢˢ ty0) (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ {σ₁ = σ₁} {σ₂ = σ₂} (tm ∷ []))))
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (tapp tm0 ty0)            = cong2 tapp (compositionalityˢˢ tm0) (compositionalityˢˢ ty0)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (tlam tm0)                = cong1 tlam (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ {σ₁ = σ₁} {σ₂ = σ₂} (ty ∷ []))))
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (const string0)           = cong1 const refl
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (tagged string0 tm0)      = cong2 tagged refl (compositionalityˢˢ tm0)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (pair string0 ℕ0 tm0 tm1) = cong4 pair refl refl (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (α→β tm0 tm1)             = cong2 α→β (compositionalityˢˢ tm0) (compositionalityˢˢ tm1)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (mkℕ′ ℕ0)                 = cong1 mkℕ′ refl
...
{-# REWRITE
  ...
  inst-const instᴿ-const
  inst-tagged instᴿ-tagged
