...
opaque
  ...
  compositionalityˢᴿ (Res proc0)             = cong1 Res (trans (compositionalityˢᴿ proc0) (cong1 (proc0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (chan ∷ []))))
  compositionalityˢᴿ (Par proc0 proc1)       = cong2 Par (compositionalityˢᴿ proc0) (compositionalityˢᴿ proc1)
  compositionalityˢᴿ (In chan0 proc0)        = cong2 In (compositionalityˢᴿ chan0) (trans (compositionalityˢᴿ proc0) (cong1 (proc0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (chan ∷ []))))
  ...
  compositionalityˢˢ (Res proc0)             = cong1 Res (trans (compositionalityˢˢ proc0) (cong1 (proc0 ⋯ˢ_) (lift-dist-compˢ*ˢ (chan ∷ []))))
  compositionalityˢˢ (Par proc0 proc1)       = cong2 Par (compositionalityˢˢ proc0) (compositionalityˢˢ proc1)
  compositionalityˢˢ (In chan0 proc0)        = cong2 In (compositionalityˢˢ chan0) (trans (compositionalityˢˢ proc0) (cong1 (proc0 ⋯ˢ_) (lift-dist-compˢ*ˢ (chan ∷ []))))
