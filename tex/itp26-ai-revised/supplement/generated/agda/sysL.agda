...
opaque
  ...
  instᴿ-lam  = refl
  instᴿ-mu   : (mu cmd0) ⋯ᴿ ρ         ≡ mu (cmd0 ⋯ᴿ (ρ ↑ᴿ* (stack ∷ [])))
  instᴿ-mu   = refl
  instᴿ-cons : (cons tm0 stack0) ⋯ᴿ ρ ≡ cons (tm0 ⋯ᴿ ρ) (stack0 ⋯ᴿ ρ)
  instᴿ-cons = refl
  instᴿ-cut  : (cut tm0 stack0) ⋯ᴿ ρ  ≡ cut (tm0 ⋯ᴿ ρ) (stack0 ⋯ᴿ ρ)
  instᴿ-cut  = refl
  inst-lam  : (lam tm0) ⋯ˢ σ         ≡ lam (tm0 ⋯ˢ (σ ↑ˢ* (tm ∷ [])))
  inst-lam  = refl
  inst-mu   : (mu cmd0) ⋯ˢ σ         ≡ mu (cmd0 ⋯ˢ (σ ↑ˢ* (stack ∷ [])))
  inst-mu   = refl
  inst-cons : (cons tm0 stack0) ⋯ˢ σ ≡ cons (tm0 ⋯ˢ σ) (stack0 ⋯ˢ σ)
  inst-cons = refl
  inst-cut  : (cut tm0 stack0) ⋯ˢ σ  ≡ cut (tm0 ⋯ˢ σ) (stack0 ⋯ˢ σ)
  inst-cut  = refl
  ...
  compositionalityᴿˢ {σ₂ = σ₂} (mu cmd0)         = cong1 mu (trans (compositionalityᴿˢ cmd0) (cong1 (cmd0 ⋯ˢ_) (lift-dist-comp*ᴿˢ {σ₂ = σ₂} (stack ∷ []))))
  compositionalityᴿˢ {σ₂ = σ₂} (cons tm0 stack0) = cong2 cons (compositionalityᴿˢ tm0) (compositionalityᴿˢ stack0)
  compositionalityᴿˢ {σ₂ = σ₂} (cut tm0 stack0)  = cong2 cut (compositionalityᴿˢ tm0) (compositionalityᴿˢ stack0)
  ...
  compositionalityˢᴿ {σ₁ = σ₁} (mu cmd0)         = cong1 mu (trans (compositionalityˢᴿ cmd0) (cong1 (cmd0 ⋯ˢ_) (lift-dist-comp*ˢᴿ {σ₁ = σ₁} (stack ∷ []))))
  compositionalityˢᴿ {σ₁ = σ₁} (cons tm0 stack0) = cong2 cons (compositionalityˢᴿ tm0) (compositionalityˢᴿ stack0)
  compositionalityˢᴿ {σ₁ = σ₁} (cut tm0 stack0)  = cong2 cut (compositionalityˢᴿ tm0) (compositionalityˢᴿ stack0)
  ...
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (mu cmd0)         = cong1 mu (trans (compositionalityˢˢ cmd0) (cong1 (cmd0 ⋯ˢ_) (lift-dist-comp*ˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (stack ∷ []))))
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (cons tm0 stack0) = cong2 cons (compositionalityˢˢ tm0) (compositionalityˢˢ stack0)
  compositionalityˢˢ {σ₁ = σ₁} {σ₂ = σ₂} (cut tm0 stack0)  = cong2 cut (compositionalityˢˢ tm0) (compositionalityˢˢ stack0)
