...
module Languages.STLCSums where
...
data _⊢[_]_ where
  ...
  inl  : S ⊢ expr → S ⊢ expr
  inr  : S ⊢ expr → S ⊢ expr
  case : S ⊢ expr → (expr ∷ S) ⊢ expr → (expr ∷ S) ⊢ expr → S ⊢ expr
...
opaque
  ...
  (inl expr0)              [ ξ ]ᴿ = inl (expr0 [ ξ ]ᴿ)
  (inr expr0)              [ ξ ]ᴿ = inr (expr0 [ ξ ]ᴿ)
  (case expr0 expr1 expr2) [ ξ ]ᴿ = case (expr0 [ ξ ]ᴿ) (expr1 [ ξ ↑ᴿ expr ]ᴿ) (expr2 [ ξ ↑ᴿ expr ]ᴿ)
...
opaque
  ...
  (inl expr0)              [ σ ]ˢ = inl (expr0 [ σ ]ˢ)
  (inr expr0)              [ σ ]ˢ = inr (expr0 [ σ ]ˢ)
  (case expr0 expr1 expr2) [ σ ]ˢ = case (expr0 [ σ ]ˢ) (expr1 [ σ ↑ˢ expr ]ˢ) (expr2 [ σ ↑ˢ expr ]ˢ)
...
opaque
  ...
  instᴿ-inl  : (inl expr0) [ ξ ]ᴿ              ≡ inl (expr0 [ ξ ]ᴿ)
  instᴿ-inr  : (inr expr0) [ ξ ]ᴿ              ≡ inr (expr0 [ ξ ]ᴿ)
  instᴿ-case : (case expr0 expr1 expr2) [ ξ ]ᴿ ≡ case (expr0 [ ξ ]ᴿ) (expr1 [ ξ ↑ᴿ expr ]ᴿ) (expr2 [ ξ ↑ᴿ expr ]ᴿ)
  instᴿ-var = refl
  instᴿ-λx_  = refl
  instᴿ-_·_  = refl
  instᴿ-inl  = refl
  ...
  right-idᴿ (inl expr0)              = cong1 inl (right-idᴿ expr0)
  right-idᴿ (inr expr0)              = cong1 inr (right-idᴿ expr0)
  right-idᴿ (case expr0 expr1 expr2) = cong3 case (right-idᴿ expr0) (trans (cong (expr1 [_]ᴿ) lift-idᴿ) (right-idᴿ expr1)) (trans (cong (expr2 [_]ᴿ) lift-idᴿ) (right-idᴿ expr2))
  ...
  compositionalityᴿᴿ (inl expr0)              = cong1 inl (compositionalityᴿᴿ expr0)
  compositionalityᴿᴿ (inr expr0)              = cong1 inr (compositionalityᴿᴿ expr0)
  compositionalityᴿᴿ (case expr0 expr1 expr2) = cong3 case (compositionalityᴿᴿ expr0) (trans (compositionalityᴿᴿ expr1) (cong (expr1 [_]ᴿ) lift-dist-compᴿᴿ)) (trans (compositionalityᴿᴿ expr2) (cong (expr2 [_]ᴿ) lift-dist-compᴿᴿ))
...
opaque
  ...
  coincidence (inl expr0) ξ              = cong1 inl (coincidence expr0 ξ)
  coincidence (inr expr0) ξ              = cong1 inr (coincidence expr0 ξ)
  coincidence (case expr0 expr1 expr2) ξ = cong3 case (coincidence expr0 ξ) (trans (cong (expr1 [_]ˢ) (⟨⟩-lift {ξ = ξ})) (coincidence expr1 (ξ ↑ᴿ expr))) (trans (cong (expr2 [_]ˢ) (⟨⟩-lift {ξ = ξ})) (coincidence expr2 (ξ ↑ᴿ expr)))
  ...
  compositionalityᴿˢ (inl expr0)              = cong1 inl (compositionalityᴿˢ expr0)
  compositionalityᴿˢ (inr expr0)              = cong1 inr (compositionalityᴿˢ expr0)
  compositionalityᴿˢ (case expr0 expr1 expr2) = cong3 case (compositionalityᴿˢ expr0) (trans (compositionalityᴿˢ expr1) (cong (expr1 [_]ˢ) lift-dist-compᴿˢ)) (trans (compositionalityᴿˢ expr2) (cong (expr2 [_]ˢ) lift-dist-compᴿˢ))
  ...
  compositionalityˢᴿ′ (inl expr0)              = cong1 inl (compositionalityˢᴿ′ expr0)
  compositionalityˢᴿ′ (inr expr0)              = cong1 inr (compositionalityˢᴿ′ expr0)
  compositionalityˢᴿ′ (case expr0 expr1 expr2) = cong3 case (compositionalityˢᴿ′ expr0) (trans (compositionalityˢᴿ′ expr1) (cong (expr1 [_]ˢ) lift-⨟ˢᴿ)) (trans (compositionalityˢᴿ′ expr2) (cong (expr2 [_]ˢ) lift-⨟ˢᴿ))
  ...
  compositionalityˢˢ (inl expr0)              = cong1 inl (compositionalityˢˢ expr0)
  compositionalityˢˢ (inr expr0)              = cong1 inr (compositionalityˢˢ expr0)
  compositionalityˢˢ (case expr0 expr1 expr2) = cong3 case (compositionalityˢˢ expr0) (trans (compositionalityˢˢ expr1) (cong (expr1 [_]ˢ) lift-dist-compˢˢ)) (trans (compositionalityˢˢ expr2) (cong (expr2 [_]ˢ) lift-dist-compˢˢ))
...
opaque
  ...
  inst-inl  : (inl expr0) [ σ ]ˢ              ≡ inl (expr0 [ σ ]ˢ)
  inst-inr  : (inr expr0) [ σ ]ˢ              ≡ inr (expr0 [ σ ]ˢ)
  inst-case : (case expr0 expr1 expr2) [ σ ]ˢ ≡ case (expr0 [ σ ]ˢ) (expr1 [ σ ↑ˢ expr ]ˢ) (expr2 [ σ ↑ˢ expr ]ˢ)
  inst-var = refl
  inst-λx_  = refl
  inst-_·_  = refl
  inst-inl  = refl
...
-- 60 rules -- 33 signature-independent, 15 for the
-- iterated (variable-arity) lifting, 12 traversal rules (one instᴿ-*
-- and one inst-* per constructor, plus the variable case).

{-# REWRITE
  def-wkᴿ def-∙ᴿ-zero def-∙ᴿ-suc def-↑ᴿ-zero def-↑ᴿ-suc
  instᴿ-var instᴿ-λx_ instᴿ-_·_ instᴿ-inl instᴿ-inr instᴿ-case
  ...
  inst-var inst-λx_ inst-_·_ inst-inl inst-inr inst-case
