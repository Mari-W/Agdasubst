...
\subsection{Comparison to Proof in Transfer Hell}
\begin{figure}[t]
  \centering
  \small
  ...
  \begin{tabular}{|l|rr|rr|}
    \hline
                                          & \multicolumn{2}{c|}{\textbf{Agdasubst}}
                                          & \multicolumn{2}{c|}{\textbf{StratF}} \\
                                          & LOC & Chars & LOC & Chars \\
    \hline
    Type substitution + proofs            &   217 &  12\,246 &    285 &  12\,584 \\
    Expression substitution + proofs      &   202 &  11\,675 & 1\,405 &  69\,846 \\
    \hline
    \textbf{Total}                        & \textbf{419} & \textbf{23\,921}
                                          & \textbf{1\,690} & \textbf{82\,430} \\
    \hline
  \end{tabular}
  \caption{%
    Code required to prove the four expression-level compositionality
    lemmas (renaming/substitution fusion in all four ren/sub
    combinations) in two Agda formalizations of System~F.
    %
    Both columns are restricted to code transitively used by the four
    proofs; semantic interpretations, operational semantics, and
    unreferenced auxiliary lemmas are excluded.
    %
    LOC counts non-blank, non-comment-only lines.
  }
