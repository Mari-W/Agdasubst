...
opaque
  ...
  traversal-vt   = refl
  traversal-lam  : (lam ty0 tm0) ⋯ˢ σ  ≡ lam (ty0 ⋯ˢ σ) (tm0 ⋯ˢ (σ ↑ˢ* (vl ∷ [])))
  traversal-lam  = refl
  ...
  compositionalityᴿˢ (lam ty0 tm0)  = cong2 lam (compositionalityᴿˢ ty0) (trans (compositionalityᴿˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-comp*ᴿˢ (vl ∷ []))))
  ...
  compositionalityˢᴿ (lam ty0 tm0)  = cong2 lam (compositionalityˢᴿ ty0) (trans (compositionalityˢᴿ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ᴿ (vl ∷ []))))
  ...
  compositionalityˢˢ (lam ty0 tm0)  = cong2 lam (compositionalityˢˢ ty0) (trans (compositionalityˢˢ tm0) (cong1 (tm0 ⋯ˢ_) (lift-dist-compˢ*ˢ (vl ∷ []))))
