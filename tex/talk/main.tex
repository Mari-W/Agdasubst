...
%    but the proof assitant cannot conclude them to be. we want an automatic procedure, that enables the 
%    proof assitant to see that two terms are equal, if they are.
...
\begin{frame}[fragile]
  ...
  Solution: We need to define \AgdaFunction{wk} in terms of renamings $(\text{Variable} \to \text{Variable})\ni \rho$!
  \noindent\begin{minipage}[t]{0.48\linewidth}
    \raggedright{}
    \EYRLookUp{}
    \EYRId{}
